...
import com.julyzeng.baserecycleradapterlib.animation.AlphaInAnimation;
import com.julyzeng.baserecycleradapterlib.animation.AnimationType;
import com.julyzeng.baserecycleradapterlib.animation.BaseAnimation;
import com.julyzeng.baserecycleradapterlib.animation.BottomInRorateAnimation;
import com.julyzeng.baserecycleradapterlib.animation.CustomAnimation;
import com.julyzeng.baserecycleradapterlib.animation.ScaleInAnimation;
import com.julyzeng.baserecycleradapterlib.animation.SlideInBottomAnimation;
import com.julyzeng.baserecycleradapterlib.animation.SlideInLeftAnimation;
import com.julyzeng.baserecycleradapterlib.animation.SlideInRightAnimation;
import com.julyzeng.baserecycleradapterlib.animation.SlideInTopAnimation;
import com.julyzeng.baserecycleradapterlib.listener.OnDragAndSwipeListener;
import com.julyzeng.baserecycleradapterlib.listener.OnRecyclerItemClickListener;
import com.julyzeng.baserecycleradapterlib.listener.OnRecyclerItemLongClickListener;
...
//    private BaseViewHolder rootView;
    ...
    public void notifyDataChange(List<T> data){
        this.mData = data;
    ...
    public void openLoadAnimation(AnimationType animationType) {
        ...
        switch (animationType) {
            ...
            case SLIDE_BOTTOM_TOP:
                ...
                break;
            case BOTTOM_INTO:
                mBaseAnimation = new BaseAnimation[]{new BottomInRorateAnimation()};
                break;
            default:
                break;
        }
