    ...
    public void addViews() {
        ...
        switch (mLoadType) {
            ...
            case LOAD_TYPE_EAT_BEANS:
                ...
                break;
            case NO_MORE:
                LayoutParams layoutParams = new LayoutParams(LayoutParams.WRAP_CONTENT, dip2px(50));
                mTextView.setText(R.string.no_more);
                mTextView.setGravity(Gravity.CENTER);
                mTextView.setCompoundDrawablesWithIntrinsicBounds(getResources().getDrawable(R.mipmap.ic_no_more_data),null,null,null);
