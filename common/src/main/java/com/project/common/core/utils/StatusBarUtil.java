...
//通过判断设备是否有返回键、菜单键(不是虚拟键,是手机屏幕外的按键)来确定是否有navigation bar
     ...
     * @return
     */
    public static boolean checkDeviceHasNavigationBar(Context mc) {
        boolean hasNavigationBar = false;
        Resources rs = mc.getResources();
...
//        setRootView(activity);
     ...
     */
    public static void setTranslucentForImageViewInFragment(Activity activity, View needOffsetView, @IntRange(from = 0, to = 255) int statusBarAlpha){
