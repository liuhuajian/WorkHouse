...
public class RadiusImageView extends AppCompatImageView {
    ...
    public RadiusImageView(Context context, AttributeSet attrs) {
        this(context, attrs,R.style.RadiusImageViewStyle);
    }
    ...
    public RadiusImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderWidth = array.getDimensionPixelSize(R.styleable.RadiusImageView_qmui_border_width, 0);
        mBorderColor = array.getColor(R.styleable.RadiusImageView_qmui_border_color, DEFAULT_BORDER_COLOR);
        mSelectedBorderWidth = array.getDimensionPixelSize(
                R.styleable.RadiusImageView_qmui_selected_border_width, mBorderWidth);
        mSelectedBorderColor = array.getColor(R.styleable.RadiusImageView_qmui_selected_border_color, mBorderColor);
        mSelectedMaskColor = array.getColor(R.styleable.RadiusImageView_qmui_selected_mask_color, Color.TRANSPARENT);
        ...
        mIsTouchSelectModeEnabled = array.getBoolean(R.styleable.RadiusImageView_qmui_is_touch_select_mode_enabled, true);
        mIsCircle = array.getBoolean(R.styleable.RadiusImageView_qmui_is_circle, false);
        if (!mIsCircle) {
            mIsOval = array.getBoolean(R.styleable.RadiusImageView_qmui_is_oval, false);
        }
        if (!mIsOval) {
            mCornerRadius = array.getDimensionPixelSize(R.styleable.RadiusImageView_qmui_corner_radius, 0);
        }
        setCircle(mIsCircle);
        setBorderColor(mBorderColor);
        setBorderWidth(mBorderWidth);
        setSelectedBorderWidth(mSelectedBorderWidth);
        setSelectedBorderColor(mSelectedBorderColor);
        setSelectedMaskColor(mSelectedMaskColor);
        setTouchSelectModeEnabled(mIsTouchSelectModeEnabled);
        setOval(mIsOval);
